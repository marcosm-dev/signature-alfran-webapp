    ...
    <v-col cols="10">
      ...
      <div class="text-start mt-5">
        ...
        <div class="mt-10">
          ...
          <div class="city">
            En
            <input type="text" label="Las Palmas" />
            ...
            <v-col cols="4" class="text-center">
              <v-dialog v-model="dialog">
                ...
                <v-card height="500px">
                  ...
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="primary" text @click="dialog = false">Volver</v-btn>
                  </v-card-actions>
                </v-card>
              </v-dialog>
              <v-img :src="data" />
